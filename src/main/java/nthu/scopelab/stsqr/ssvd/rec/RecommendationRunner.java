...
public class RecommendationRunner{
	...
	RecommendationJob recjob = new RecommendationJob(ctx,ssvdrunner.getUPath(),outputpath+"/Recommendation",ssvdrunner.getVPath(), ssvdrunner.getSigma(), thItem, numrec);
	recjob.run();
